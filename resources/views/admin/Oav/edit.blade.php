...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>ОАВ нашриёт ишлари ўзгартириш</h2>
        </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('oavpublish.update',$oavpublishes->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label for="name"><b>Ишлар номи</b></label>
                                <input type="text" name="name" id="name" class="form-control" value="{{ $oavpublishes->name }}" required>
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="fio" name="fio" id="fio" class="form-control" value="{{ $oavpublishes->fio }}" required>
                            </div>

                            <div class="form-group col-lg-6">
                                <label for="jurnal_name"><b>ОАВ номи</b></label>
                                <input type="oav_name" name="oav_name" id="oav_name" class="form-control" value="{{ $oavpublishes->oav_name }}" required>
                            </div>                

                            <div class="form-group col-lg-6">
                                <label for="number"><b>Ҳавола</b></label>
                                <textarea type="link" name="link" id="summernote" class="form-control" value="" required>{{ $oavpublishes->link }}</textarea>
                            </div>   

                            <div class="form-group col-lg-2">
                                <label for="date"><b>Нашр этилган санаси</b></label>
                                <input type="date" name="date" id="date" class="form-control" value="{{ $oavpublishes->date }}" required>
                            </div>             
