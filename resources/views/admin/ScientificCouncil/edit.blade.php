...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('scientific.update',$scientifics->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" name="type" id="type" class="form-control" value="{{ $scientifics->type }}" required>
                            </div>

                            <div class="form-group col-lg-2">
                                <label for="start_date"><b>ўқишга кирган сана</b></label>
                                <input type="date" name="start_date" id="start_date" class="form-control" value="{{ $scientifics->start_date }}" required>
                              </div>
              
                              <div class="form-group col-lg-2">
                                <label for="end_date"><b>ўқишни битирган сана</b></label>
                                <input type="date" name="end_date" id="end_date" class="form-control" value="{{ $scientifics->end_date }}" required>
                              </div>
