...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>ИИК ҳузуридаги семинарлар ўзгартириш</h2>
        </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('seminar.update',$scientifics->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" name="organizationName" id="organizationName" class="form-control" value="{{ $scientifics->organizationName }}" required>
                            </div>

                            <div class="form-group col-lg-6">
                                <label for="author"><b>Диссертация мавзуси</b></label>
                                <textarea type="text" name="topic" id="summernote" class="form-control" value="" required>{{ $scientifics->topic }}</textarea>
                            </div>

                            <div class="form-group col-lg-6">
                                <label for="author"><b>Илмий раҳбарининг ф.и.ш.</b></label>
                                <input type="text" name="leaderName" id="leaderName" class="form-control" value="{{ $scientifics->leaderName }}" required>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select name="degree_id" id="degree_id" class="form-control" required>
                                    ...
                                    <option value="{{ $type->id }}" 
                                        {{ (old('degree_id', $scientifics->degree_id ?? '') == $type->id) ? 'selected' : '' }}>
                                        {{ $type->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-2">
                              ...
                              <div class="form-group col-lg-2">
                                ...
                                <input type="number" name="number" id="number" class="form-control" value="{{ $scientifics->number }}" min="0" required>
                              </div>

                              <div class="form-group col-lg-6">
                                <label for="author"><b>ИС хулосаси</b></label>
                                <textarea type="text" name="conclusion" id="summernote2" class="form-control" value="" required>{{ $scientifics->conclusion }}</textarea>
                              </div>
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select name="quarters_id" id="quarters_id" class="form-control" required>
                                    ...
                                    <option value="{{ $quarter->id }}" 
                                        {{ (old('quarters_id', $scientifics->quarters_id ?? '') == $quarter->id) ? 'selected' : '' }}>
                                        {{ $quarter->name }}
                                      </option>
                                    @endforeach
                                </select>
